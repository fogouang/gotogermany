<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else class="max-w-6xl mx-auto px-4 py-8 space-y-5">

      <!-- Hero Score — pleine largeur -->
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <!-- Colonne gauche : critères + corrections + conseils -->
        ...
        <!-- Colonne droite : feedbacks par tâche -->
                ...
                <TabPanel v-for="task in store.taskList" :key="task.key" :value="task.key" class="px-5 py-5 space-y-5">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div class="bg-gray-50 border border-gray-200 rounded-xl p-4 h-full">
                        <p class="text-sm text-gray-700 whitespace-pre-line leading-relaxed">
                          {{ originalAnswers[task.key] || 'Texte original non disponible.' }}
                        </p>
                      </div>
                    </div>
                    ...
                    <div v-if="task.correctedText">
                      ...
                      <div class="bg-teal-50 border border-teal-200 rounded-xl p-4 h-full">
...
const originalAnswers = computed(() => store.originalAnswers)
