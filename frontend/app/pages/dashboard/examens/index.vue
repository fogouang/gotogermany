  ...
  <div>
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600">
        Choisissez un examen et commencez votre préparation
      </p>
    </div>
      ...
      <div v-for="(exams, provider) in groupedExams" :key="provider">
        ...
        <div class="space-y-4">
          <div
            v-for="exam in exams"
            :key="exam.id"
            class="group bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md hover:border-primary-200 transition-all duration-200 overflow-hidden"
          >
            <div class="flex items-stretch">
              <!-- Left accent -->
              <div
                class="w-1.5 bg-secondary-500 shrink-0 transition-all duration-300"
              ></div>
              ...
              <div class="flex-1 px-4 py-4 min-w-0">
                ...
                <div class="flex items-start justify-between gap-2 mb-2">
                  <span
                    class="text-xs font-semibold text-primary-600 uppercase tracking-wide"
                  >
                  ...
                  <div class="flex gap-2 shrink-0">
                    <Button
                      icon="pi pi-play"
                      size="small"
                      class="bg-gradient-primary! border-none! text-white!"
                ...
                <!-- Nom -->
                <h3
                  class="text-base font-bold text-gray-900 group-hover:text-primary-700 transition-colors mb-1 truncate"
                >
                  {{ exam.name }}
                </h3>
                ...
                <p class="text-sm text-gray-500 line-clamp-1 mb-3">
                  {{
                    exam.description ||
                    "Préparez-vous efficacement pour cet examen d'allemand."
                  }}
                </p>
                ...
                <div class="flex flex-wrap gap-2">
                  ...
                  >
                    ...
                    <span
                      ...
                      class="text-xs text-success-600 font-medium flex items-center gap-0.5"
                    >
                      <i class="pi pi-check-circle text-xs"></i> Accès actif
                    </span>
                    <span
                      v-else-if="level.is_free"
                      class="text-xs text-primary-500 font-medium flex items-center gap-0.5"
                    >
                      <i class="pi pi-lock-open text-xs"></i> Gratuit
                    </span>
                    <span
                      v-else
                      class="text-xs text-gray-400 font-medium flex items-center gap-0.5"
                    >
