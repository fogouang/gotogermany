        ...
        >
          ...
          <div class="p-6 flex flex-col flex-1">
            ...
            <p class="text-sm text-gray-500 mb-6 flex-1">
              {{
                plan.description ||
                `${t("pricing.default_description")} ${formatDuration(plan.duration_days)}`
              }}
            </p>
            ...
            <!-- Features cochées pour ce plan -->
            <ul
              v-if="plan.features && plan.features.length > 0"
              class="space-y-2 mb-6 text-sm text-gray-600"
            >
              <li
                v-for="featKey in plan.features"
                :key="featKey"
                class="flex items-center gap-2"
              >
                <i class="pi pi-check-circle text-green-500"></i>
                {{ t(`pricing.features.${featKey}`) }}
              </li>
            </ul>
